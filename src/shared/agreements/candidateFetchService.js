...
export async function fetchAgreementCandidates(params = {}) {
  ...
  companies.forEach((company) => {
    ...
    out.push({
      ...
      debtRatio,
      currentRatio,
      debtAgainstAverage: industryAvg?.debtRatio > 0 ? (debtRatio / industryAvg.debtRatio) * 100 : null,
      currentAgainstAverage: industryAvg?.currentRatio > 0 ? (currentRatio / industryAvg.currentRatio) * 100 : null,
